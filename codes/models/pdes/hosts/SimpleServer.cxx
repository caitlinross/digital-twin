...
//    m_local.EventType = SimpleServerEventTypes::REQ;
    ...
    m->ret = model_net_event(NETWORK_ID, "test", dest_id, PAYLOAD_SZ, 0.0, sizeof(SimpleServerMsg), &m_remote, sizeof(SimpleServerMsg), &m_local, lp);
    ns->msg_sent_count++;
}
    ...
    tw_lp * lp)
{
    ...
    {
	m->ret = model_net_event(NETWORK_ID, "test", m->src, PAYLOAD_SZ, 0.0, sizeof(SimpleServerMsg), &m_remote, sizeof(SimpleServerMsg), &m_local, lp);
        ns->msg_sent_count++;
