...
#define MAX_NAME_LENGTH 256
  ...
  // void codes_mapping_get_lp_info(tw_lpid gid, char* group_name, int* grp_id, int* lp_type_id,
  // char* lp_type_name, int* grp_rep_id, int* offset);
  ...
  const char* codes_mapping_get_annotation_by_name(
    const char* group_name, const char* lp_type_name);
