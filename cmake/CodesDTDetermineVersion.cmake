...
# Used to determine the version for CODES Digital Twin source using "git describe", if git
...
#   var_prefix : prefix for variables e.g. "CODES_DT".
function(determine_version source_dir git_command var_prefix)
  if ("$Format:$" STREQUAL "")
    ...
    # this function.
    return ()
elseif (NOT CODES_DT_GIT_DESCRIBE AND
    ...
    # note, output may be set to empty if CODES_DT_GIT_DESCRIBE is not defined.
    set(output "${CODES_DT_GIT_DESCRIBE}")
  endif()
